...
requirejs.config({
    ...
    paths: {
        ...
        'lazyloader': 'lib/jquery.bttrlazyloading.min',
        'transitions': 'js/pagetransitions',

        // offcanvas group
        'offcanvas': 'lib/jquery.offcanvas',
        'overthrow': 'lib/overthrow',
        'hammer': 'lib/hammer',
        'jhammer': 'lib/jquery.hammer',
        ...
        // fullpage group
        'easing': 'lib/jquery.easings-1.9.2.min',
...
require(['modernizr'], function ()
{
    require(['jquery', 'domReady'], function ($, domReady)
    {
        ...
        domReady(function ()
        {
            require(['angular', 'bootstrap', 'classie', 'easing', 'slimscroll', 'fullpage', 'lazyloader'], function (ng)
            {
                ...
                $('#page').fullpage({
                    ...
                    'autoScrolling': false
                    //'navigation': true, // if "autoScrolling" is false then "navigation" is false
                    //'scrollOverflow': true // activate for mobile
			    });
